...
import novios from "@/assets/itinerario/novios.jpg";
...
const ARRAY_IMG = [iglesia, fotos, novios, cena, vela, fiesta, despedida];
    ...
    <>
      ...
      <div className="max-w-screen-xl mx-auto h-fit">
        <motion.div
          ...
          className="my-40 mx-8 text-center lg:text-left"
        >
          ...
          <div className="my-8 flex flex-col gap-5 items-center justify-center font-semibold">
            Adoramos a los niños, pero creemos que merecen descansar ¡Niños,
            dulces sueños! <FaBaby size={40} />{" "}
          </div>
          ...
          <div className="grid gap-8 md:p-12 grid-cols-1 lg:grid-cols-2 mt-20 ">
            ...
            <div className="rounded-lg shadow-xl shadow-thPrimary mx-auto ">
              <div className="flex flex-col items-center justify-center  ">
                ...
                <p className="m-4 text-sm md:text-lg font-semibold text-center">
                  Calle De Los Santos De Piedra <br /> CRA 4 Cartagena,Bolivar
                </p>
                <p className="m-4 text-sm md:text-lg font-semibold text-center">
                  3:00 PM
                </p>
                <div className="mb-6 hover:scale-110 duration-300">
                  <a
                    href="https://www.google.com/maps/place/Catedral+de+Santa+Catalina+de+Alejandr%C3%ADa/@10.4236564,-75.550932,17z/data=!3m1!4b1!4m6!3m5!1s0x8ef62f9ff3e34a7b:0xe48918f3f4c4ecdd!8m2!3d10.4236564!4d-75.550932!16s%2Fm%2F0g5681n"
                    target="_blank"
                    rel="noreferrer"
                  >
            ...
            <div className="rounded-lg shadow-xl shadow-thPrimary mx-auto ">
              <div className="flex flex-col items-center justify-center  ">
                ...
                />
                <p className="m-4 capitalize text-sm md:text-lg text-thPrimary font-semibold text-center">
                  Recepcion <br /> Hotel Monterrey{" "}
                </p>
                <p className="m-4 text-sm md:text-lg font-semibold text-center">
                  CRA 8B # 25-100 <br /> La Matuna, Cartagena, Bolivar
                </p>
                <p className="m-4 text-sm md:text-lg font-semibold text-center">
                  5:00 PM
                </p>
                <div className="mb-6 hover:scale-110 duration-300">
                  <a
                    href="https://www.google.com/maps/place/Hotel+Monterrey/@10.4216641,-75.549846,17z/data=!3m1!4b1!4m9!3m8!1s0x8ef62f75838b9b25:0x95117324d7db4fd0!5m2!4m1!1i2!8m2!3d10.4216641!4d-75.5476573!16s%2Fg%2F1ygb7ndty?coh=164777&entry=tt&shorturl=1"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiGooglemaps size={30} fill={"black"} />
