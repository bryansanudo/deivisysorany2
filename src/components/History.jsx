...
const History = () => {
  ...
  return (
    <>
      <h1 className="text-black" name="nuestra historia">
        .
      </h1>
      <motion.div
      ...
      >
        <div className="my-40 mx-8 text-center lg:text-left">
          ...
          <div className="my-8 flex flex-col gap-5 items-center justify-center font-semibold">
            El día que decidimos unir nuestras vidas, lo hicimos con la sincera
            intención de caminar, reír, llorar y superarlo todo juntos.
          </div>
